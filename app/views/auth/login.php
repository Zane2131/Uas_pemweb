    ...
    <div class="container d-flex justify-content-center align-items-center vh-100 position-relative" style="z-index:1;">
        <div class="card w-100" style="max-width: 410px;">
            <div class="card-header py-4">
                ...
                <h5 class="mb-0 text-chess">Login Anggota</h5>
            </div>
            <div class="card-body">
                ...
                <form id="loginForm" action="public/index.php?controller=auth&action=doLogin" method="POST" autocomplete="off">
                    <div class="mb-3">
                    ...
                    <div class="d-grid">
                        <button type="submit" class="btn btn-chess py-2">
                            <i class="fas fa-chess-knight me-1"></i>Masuk
                        </button>
                    </div>
                </form>
                <div class="mt-4 text-center">
                    <span class="text-chess">Belum punya akun?</span>
                    <a href="index.php?controller=auth&action=register" class="text-decoration-none fw-bold" style="color:#fffbe6;">
                        <i class="fas fa-chess-pawn me-1"></i>Daftar
                    </a>
                </div>
            </div>
        </div>
